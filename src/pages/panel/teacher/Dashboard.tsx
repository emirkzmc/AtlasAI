  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <div>
          <h1 style={styles.title}>Öğretmen Paneli</h1>
          <p style={styles.info}>{user?.email}</p>
          <p style={styles.role}>Rol: Öğretmen</p>
        </div>
      ...
      <div style={styles.card}>
        <h2 style={styles.cardTitle}>Sınıflarım</h2>
        <div style={styles.cardContent}>
          <p style={styles.placeholder}>Henüz sınıf bulunmamaktadır.</p>
        </div>
      </div>
    </div>
  );
...
const styles: Record<string, React.CSSProperties> = {
  ...
  logoutBtn: { padding: "10px 24px", borderRadius: "10px", border: "none", background: "#1a1a1a", color: "#fff", fontSize: "14px", fontWeight: 600, cursor: "pointer", fontFamily: "inherit" },
